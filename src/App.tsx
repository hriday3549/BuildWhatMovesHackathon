...
export default function App() {
  ...
  return <main>
    ...
    {view === 'report' && <section className="shell">
      <div className="hero"><p className="eyebrow"><Sparkles size={15}/> {language === 'en' ? 'CUT THE RED TAPE' : 'लालफीताशाही कम करें'}</p><h1>{language === 'en' ? <>Complaints that get finished,<br/><em>not just filed.</em></> : <>शिकायतें पूरी हों,<br/><em>सिर्फ दर्ज नहीं।</em></>}</h1><p>{language === 'en' ? 'Tell Nivaran what happened. We route it to the right ward team, show the evidence, and keep the outcome in your hands.' : 'निवारण को बताएं कि क्या हुआ। हम आपकी शिकायत सही टीम तक पहुंचाएंगे और कार्रवाई का प्रमाण दिखाएंगे।'}</p></div>
